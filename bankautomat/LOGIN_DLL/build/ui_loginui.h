...
public:
    ...
    {
        LoginUi->setWindowTitle(QCoreApplication::translate("LoginUi", "Log in", nullptr));
        lineEdit->setPlaceholderText(QCoreApplication::translate("LoginUi", "Enter 4 digit pin.", nullptr));
